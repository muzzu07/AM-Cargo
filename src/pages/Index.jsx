  ...
  const services = [
    {
      title: "Fleet Owners",
      description:
        "Professional fleet management with modern vehicles for reliable transportation",
      icon: Truck,
    },
    {
      title: "Transport Contractors",
      description:
        "Comprehensive transport contracting services across all major routes",
      icon: Building,
    },
    {
      title: "Commission Agent",
      description:
        "Trusted commission agent services with transparent dealings",
      icon: Shield,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-3 text-primary-foreground">
              <Logo
                size="md"
                className="hidden md:block text-primary-foreground"
              />
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-primary-foreground max-w-4xl mx-auto px-4 sm:px-6 animate-fade-in-up rounded-none border-none">
          ...
          <p className="text-base sm:text-lg mb-6 sm:mb-8 opacity-80 max-w-2xl mx-auto animate-fade-in delay-500 px-4">
            Professional fleet owners, transport contractors, and commission
            agents serving Vapi, Daman, Silvassa, Bangalore, and all over India
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center animate-fade-in delay-700 px-4">
            <Link to="/contact" className="w-full sm:w-auto">
              <Button
                variant="hero"
                size="lg"
                className="text-base sm:text-lg hover:scale-105 transition-transform duration-300 w-full sm:w-auto"
              >
                Get Quote
              </Button>
            </Link>
      ...
      <section id="about" className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8 text-foreground animate-fade-in-up">
              About A.M. Cargo Movers
            </h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="text-left animate-fade-in">
                <p className="text-lg text-muted-foreground mb-6">
                  Established in 2010, A.M Cargo Movers has been a trusted name
                  in the transportation industry for over a decade. We
                  specialize in providing comprehensive logistics solutions as
                  fleet owners, transport contractors, and commission agents.
                </p>
      ...
      <section id="services" className="py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16 animate-fade-in-up">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 text-foreground px-2">
              Our Services
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {services.map((service, index) => (
              <Card
                key={index}
                className="shadow-card hover:shadow-hero transition-all duration-500 bg-gradient-card border-0 animate-fade-in hover:scale-105 group"
              ...
              >
                <CardContent className="p-4 sm:p-6 lg:p-8 text-center">
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-3 sm:mb-4 text-foreground group-hover:text-primary transition-colors duration-300">
                    {service.title}
                  </h3>
            ...
            <div className="bg-gradient-card rounded-lg p-4 sm:p-6 lg:p-8 shadow-card animate-scale-in hover:shadow-hero transition-all duration-500">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                {locations.map((location, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-2 p-2 sm:p-3 bg-primary/10 rounded-lg hover:bg-primary/20 hover:scale-105 transition-all duration-300 animate-fade-in"
              ...
              <div className="mt-6 sm:mt-8 text-center animate-fade-in">
                <p className="text-base sm:text-lg font-semibold text-primary mb-2 animate-float">
                  And All Over India
                </p>
                <p className="text-sm sm:text-base text-muted-foreground px-4">
                  We provide transportation services to all major cities and
      ...
      <section
        id="contact"
        className="py-12 sm:py-16 lg:py-20 bg-gradient-hero"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 text-primary-foreground px-2">
              Contact Us
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <Card className="bg-primary-foreground/10 backdrop-blur-sm border-primary-foreground/20">
                <CardContent className="p-4 sm:p-6 lg:p-8">
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-primary-foreground">
                    Get in Touch
                  </h3>
